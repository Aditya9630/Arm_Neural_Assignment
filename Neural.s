...
__main    FUNCTION
	...
	VLDR.F32 S25,=0.5; given as treshold for deciding logic value


AND_logic	BL printMsg1
;weights and vias vlue given in pytho code
	VLDR.F32 S7,=-0.1 
	VLDR.F32 S8,=0.2
	VLDR.F32 S9,=0.2
	VLDR.F32 S10,=-0.2
...
Data_Set1	MOV R0, #1; input A of logic gate
			VMOV.F32 S16,R0; moving A to fp register
			VCVT.F32.S32 S16,S16; converting A to signed fp number
			
			MOV R1, #0; input B of logic gate
			VMOV.F32 S17, R1; moving B to fp register
			VCVT.F32.S32 S17,S17; converting B to signed fp number
			
			MOV R2, #0; input C of logic gate
			VMOV.F32 S18,R2; moving C to fp register
			VCVT.F32.S32 S18,S18; converting C to signed fp number
...
WEIGHT_CALCULATION	VMUL.F32 S19,S7,S16;
					...
					VADD.F32 S22, S22, S10; Final value is  stored in S22		
					B exp
